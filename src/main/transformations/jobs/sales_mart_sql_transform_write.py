...
from pyspark.sql.functions import substring, col, concat, lit, rank, when
...
def sales_mart_calculation_table_write(final_sales_team_data_mart_df):
    ...
    final_sales_team_data_mart = final_sales_team_data_mart_df.withColumn("total_sales_every_month", sum(col("")))
...
#                        col("sales_person_last_name")).alias("full_name"), "sales_month",
...
#
#     # Write the data into MYSQL sales team data mart table
